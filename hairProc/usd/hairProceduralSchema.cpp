...
TF_DEFINE_PUBLIC_TOKENS(HairProcHairProceduralSchemaTokens,
                        HAIRPROC_SCHEMA_TOKENS);
...
HairProcHairProceduralSchema HairProcHairProceduralSchema::GetFromParent(
...
HairProcHairProceduralSchema::Builder::SetParamuv(
...
HairProcHairProceduralSchema::Builder &
HairProcHairProceduralSchema::Builder::SetTarget(
    const HdPathArrayDataSourceHandle &target) {
    _target = target;
    return *this;
}
...
HairProcHairProceduralSchema::Builder &
HairProcHairProceduralSchema::Builder::SetPrim(
    const HdIntArrayDataSourceHandle &prim) {
    _prim = prim;
    return *this;
}
...
HairProcHairProceduralSchema::Builder &
HairProcHairProceduralSchema::Builder::SetRest(
    const HdVec3fArrayDataSourceHandle &rest) {
    _rest = rest;
    return *this;
}
...
HdContainerDataSourceHandle HairProcHairProceduralSchema::Builder::Build() {
    return HairProcHairProceduralSchema::BuildRetained(_paramuv, _target, _prim,
                                                       _rest);
}
