...
#define HAIRPROC_SCHEMA_TOKENS (hairProcedural)(target)(prim)(paramuv)(rest)

TF_DECLARE_PUBLIC_TOKENS(HairProcHairProceduralSchemaTokens, HAIRPROC_API,
                         HAIRPROC_SCHEMA_TOKENS);

class HairProcHairProceduralSchema : public HdSchema {
  public:
    HairProcHairProceduralSchema(HdContainerDataSourceHandle container)
        : HdSchema(container) {}
    ...
    HAIRPROC_API
    static HairProcHairProceduralSchema
    ...
    BuildRetained(const HdVec2fArrayDataSourceHandle &uv,
