...
class HairProcHairProceduralSceneIndex final
    : public HdSingleInputFilteringSceneIndexBase {
  public:
    HAIRPROC_API
    static HairProcHairProceduralSceneIndexRefPtr
  ...
  private:
    ...
    typedef std::map<SdfPath, std::unordered_set<SdfPath, SdfPath::Hash>>
        _TargetsMap;
    mutable _TargetsMap _targets;

    typedef std::unordered_map<SdfPath, HairProcHairProceduralDeformerSharedPtr,
                               SdfPath::Hash>
        _HairProcMap;
